...
/*Review: everything works well and no errors pulling information. some of the null checks are missing ? to return the null error message but other than that everything is good. */
